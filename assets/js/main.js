...
document.querySelector('#mobile-menu-icon>.header-icon-button-icon').addEventListener('click', function (event) {
...
// Header alert button.
document.querySelector('#alert-icon>.header-icon-button-icon').addEventListener('click', function (event) {
...
// Header user button.
document.querySelector('#user-icon>.header-icon-button-icon').addEventListener('click', function (event) {
...
document.querySelector('#modal-window-sample-button-1').addEventListener('click', function () {
    ...
    setTimeout(function () { modal_window.classList.add('is-open'); }, 1);
});
document.querySelector('#modal-window-sample-button-2').addEventListener('click', function () {
...
window.onclick = function (event) {
    ...
    for (const dropdown of document.querySelectorAll('.dropdown-window.is-open')) {
        if (!dropdown.contains(event.target) && !dropdown.parentNode.contains(event.target)) {
