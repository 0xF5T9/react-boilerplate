/**
 * @file signup_form.js
 * @description Load the signup form.
 */
...
import * as inputComponents from './components/input.js';
...
(() => {
    ...
    // Render the form.
    const signup_form_container = createRoot($('#signup-form-modal-window'));
    signup_form_container.render(<SignupForm />);
})();
